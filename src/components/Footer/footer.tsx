...
type Footerhome = React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement> &
  Partial<{}>;
          ...
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <div className="flex flex-col gap-[23px] justify-start md:ml-[0] ml-[316px] mr-[178px] mt-[31px] w-[68%] md:w-full">
              ...
              <Text
                ...
                variant="body30"
              >
                CinemaDBS.com is the website catering to every individuals belonging to the Indian
                Film Industry to use and explore the content and features of this website. For any
                more information, please contact with the options given under contact us.
              </Text>
            </div>
            <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[45px] w-full">
              ...
              <div className="flex md:flex-1 flex-row items-start justify-center md:mt-0 mt-3 w-auto md:w-full">
                ...
                <div className="flex items-center justify-start ml-7 mt-[5px] w-[13%]">
                  <Img src="images/img_twitter.svg" className="h-3.5 w-auto" alt="twitter" />
                </div>
                <Img
