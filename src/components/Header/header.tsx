...
type OTTHeadergroup986Props = React.DetailedHTMLProps<
  React.HTMLAttributes<HTMLDivElement>,
  HTMLDivElement
> &
  Partial<{}>;

const OTTHeadergroup986: React.FC<OTTHeadergroup986Props> = (props) => {
    ...
    <>
      <header className={props.className}>
        ...
        <div className="flex flex-row gap-2.5 items-center justify-center mb-[35px] md:ml-[0] ml-[53px] md:mt-0 mt-[43px] w-[10%] md:w-full">
          ...
          <Img src="images/img_arrowdown.svg" className="h-[9px] w-auto" alt="arrowdown_One" />
        </div>
...
OTTHeadergroup986.defaultProps = {};

export default OTTHeadergroup986;
