...
const TermsConditionsPage: React.FC = () => {
  ...
  const [termsconditionspage, setTermsConditions] = React.useState(termsconditions)
  useEffect(() => {
    retrieveTermsAndConditions('EN', 'termsconditions')
  }, [])

  const retrieveTermsAndConditions = async (language: string, formLayout: string) => {
    await api
  ...
  return (
    ...
    <div className="flex font-montserrat items-start mt-[39px] md:px-10 sm:px-5 px-[123px] w-full">
      <Text
        ...
        variant="body11"
      >
       {termsconditionspage.headerTitle}
      </Text>
    </div>
    <Text
      ...
      variant="body26"
    >
      {termsconditionspage.paragraph1}
    </Text>
    <Text
      className="font-medium font-montserrat mt-4 text-justify text-white_A700 w-[84%] sm:w-full"
      variant="body26"
    >
     {termsconditionspage.paragraph2}
    </Text>
    <Text
      className="font-medium font-montserrat mt-4 text-justify text-white_A700 w-[84%] sm:w-full"
      variant="body26"
    >
     {termsconditionspage.paragraph3}
    </Text>
    <Text
      className="font-medium font-montserrat mt-4 text-justify text-white_A700 w-[84%] sm:w-full"
      variant="body26"
    >
      {termsconditionspage.paragraph4}
    </Text>
    <Text
      className="font-medium font-montserrat mt-3 text-justify text-white_A700 w-[84%] sm:w-full"
      variant="body26"
    >
     {termsconditionspage.paragraph5}
    </Text>
    <Text
      className="font-medium font-montserrat mt-4 text-justify text-white_A700 w-[84%] sm:w-full"
      variant="body26"
    >
     {termsconditionspage.paragraph6}
    </Text>
    <Text
      className="font-medium font-montserrat mt-4 text-justify text-white_A700 w-[84%] sm:w-full"
      variant="body26"
    >
     {termsconditionspage.paragraph7}
    </Text>
    <div className="font-montserrat md:h-[342px] h-[368px] mb-0.5 mt-4 md:px-5 relative w-full">
      <Text
        ...
        variant="body26"
      >
        {termsconditionspage.paragraph8}
      </Text>
