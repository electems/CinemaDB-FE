    ...
    <>
      <div className="bg-gray_900 flex flex-col font-roboto items-center justify-start mx-auto pt-0.5 w-full">
                ...
                <div className="flex items-center justify-start w-full">
                  <div className="flex md:flex-col flex-row md:gap-[46px] items-center justify-between w-full">
                    <div className="h-[296px] relative w-[44%] md:w-full">
                      <Img
                        src="/images/img_rectangle516.png"
                        className="h-[296px] m-auto object-cover w-full"
                        alt="rectangle516"
                      />
                      <div className="absolute bg-white_A700_7f bottom-[35%] flex flex-col h-[47px] items-start justify-end p-0.5 right-[35%] w-[47px]">
                        <Img
                          src="/images/img_play.svg"
                          className="h-[39px] ml-1 md:ml-[0] mt-0.5 rounded-[1px] w-auto"
                          alt="play"
                        />
                        <Text
                          className="ml-0.5 md:ml-[0] text-gray_900 text-left w-auto"
                          as="h5"
                          variant="h5"
                        >
                          Watch Trailer{' '}
        ...
        <div className="flex items-center justify-start mt-20 w-full">
          <OTTFooterhome className="bg-gray_800 flex flex-col items-center justify-end pt-1.5 w-full" />
        </div>
      </div>
    </>
  );
