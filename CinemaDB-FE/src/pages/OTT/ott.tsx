...
import OTTHeadergroup986 from "components/Headermain";
    ...
    <>
      <div className="bg-gray_900 flex items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          <OTTHeadergroup986 className="bg-gray_800 flex flex-row font-roboto items-center justify-center md:px-5 w-full" />
          <Text
          ...
          <OTTFooterhome className="bg-gray_800 flex font-roboto items-center justify-center mt-[50px] md:px-5 w-full" />
        </div>
      </div>
    </>
  );
